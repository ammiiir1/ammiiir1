# Frontend Developer @ Danak Corporation

Built engaging, animation-heavy web interfaces that became a portfolio showcase for the company.
...
- Designed responsive, accessible frontends across multiple projects
- Built reusable UI component systems to speed up future development

## Achievements & Highlights

- Created smooth, polished animations and interactions using GSAP and Vue.js that helped the sales team attract new clients
